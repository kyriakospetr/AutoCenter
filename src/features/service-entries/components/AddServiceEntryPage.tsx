...
import { useCreateServiceEntry } from "../hooks";
import { Vehicle } from "../../vehicles/types";
import { CreateServiceEntryDto } from "../types";
import { DatePicker } from "../../../components/DatePicker";

interface AddServiceEntryPageProps {
  vehicle: Vehicle;
  onClose: () => void;
}

export function AddServiceEntryPage({
  vehicle,
  onClose,
}: AddServiceEntryPageProps) {
  ...
  const { mutate: createService, isPending } = useCreateServiceEntry();
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const dto: CreateServiceEntryDto = {
          ...
          <div className="mb-8 flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg xl:text-xl font-bold text-slate-800 tracking-tight">
                Καταγραφή Νέας Εργασίας &mdash; {vehicle.make} {vehicle.model}{" "}
                {vehicle.plate ? `(${vehicle.plate.toUpperCase()})` : ""}
              </h2>
              <p className="text-slate-500 text-xs xl:text-sm mt-0.5">
                Συμπληρώστε τις εργασίες, τα χιλιόμετρα και τυχόν μελλοντικές
                εκκρεμότητες για το όχημα.
              </p>
            </div>
          </div>
          ...
          >
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <textarea
                ...
                onChange={handleChange}
                placeholder="π.χ. Γενικό service: Αλλαγή λαδιών 5W-30, φίλτρο λαδιού, φίλτρο αέρα, αντικατάσταση τακάκια εμπρός..."
                rows={5}
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <div className="relative">
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  placeholder="π.χ. Χρειάζεται αλλαγή βαλβολίνες στο επόμενο service ή έλεγχο για διαρροή ψυκτικού..."
                  rows={4}
            ...
            <div className="flex flex-col-reverse sm:flex-row justify-end gap-3 pt-4">
              ...
              >
                {isPending ? "Αποθήκευση..." : "Καταγραφή Αλλαγών"}
              </button>
            </div>
          </form>
        </div>
