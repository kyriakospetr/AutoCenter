...
export function UpdateVehiclePage({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    updateVehicle(
      ...
      {
        onSuccess: () => {
          setSelectedVehicle({ ...vehicle, ...dto });
          onClose();
        },
        onError: (error: any) => {
          const msg =
  ...
  return (
    <div className="w-full min-h-screen bg-slate-50/50 p-6 md:p-12 flex flex-col justify-center items-center overflow-y-auto">
        ...
        <div>
          ...
          <div>
            ...
            <p className="mt-2 text-base text-slate-500">
              Τροποποίηση των στοιχείων του πελάτη και του αυτοκινήτου.
            </p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-3xl border border-slate-200/80 shadow-sm p-8 xl:p-12 w-full">
          <form onSubmit={handleSubmit} className="space-y-8" noValidate>
            ...
            <div className="flex flex-col-reverse sm:flex-row justify-end gap-3 pt-4">
              ...
              >
                {isPending ? "Ενημέρωση..." : "Αποθήκευση αλλαγών"}
              </button>
            </div>
          </form>
        </div>
